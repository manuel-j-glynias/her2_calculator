...
const CountsInputPanelReviewer : React.FC<Props> = ({num_nuclei,set_num_nuclei,num_her2,set_num_her2,num_cep17,set_num_cep17,reset,results}) => {
    ...
    return (
        <Fragment>
            <div>Number Nuclei Counted ({results==null ? '' : results.num_nuclei})</div>
            <div>
            ...
            <div>HER2 Counts ({results==null ? '' :results.num_her2})</div>
            <div>
            ...
            <div>CEP17 Counts ({results==null ? '' :results.num_cep17})</div>
            <div>
